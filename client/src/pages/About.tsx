      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-20">
          <div className="text-center mb-10">
            <h3 className="text-2xl font-bold font-poppins mb-4 text-text">Our Products</h3>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Discover our innovative solutions designed to make waste management easier and more effective.
            </p>
          </div>
